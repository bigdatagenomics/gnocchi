...
val geno1 = sc.loadGenotypesAsText(genotypesPath1)
val pheno1 = sc.loadPhenotypes(phenotypesPath1, "IID", "pheno_1", "\t", Option(phenotypesPath1), Option(List("pheno_2", "pheno_3")))
