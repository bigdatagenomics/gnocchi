...
from bdgenomics.gnocchi.utils.primitives import CalledVariantDataset, LogisticVariantModelDataset
...
class LogisticGnocchiModel(object):
    ...
    def New(cls,
        ...
        sc = ss.sparkContext
        jvm = sc._jvm
        jlgmf = jvm.org.bdgenomics.gnocchi.api.java.models.JavaLogisticGnocchiModelFactory
        ...
        jlgm = jvm.org.bdgenomics.gnocchi.api.java.models.JavaLogisticGnocchiModel(lgm)
